...
% Description:
%
%   test of the generic green channel mean feature extraction on given sample rgb data
%
...
[pearson, rmse, snr, snr_var, bpm] = ground_truth_stats.get(ppg,signal_filtered(:,2),fs);
